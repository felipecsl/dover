...
namespace Com.Dover.Tests.Controllers {
    ...
    public class AccountControllerTest {
        ...
        public void ChangePasswordPostReturnsViewIfCurrentPasswordNotSpecified() {
            ...
            // Assert
            Assert.AreEqual(6, result.ViewData["PasswordLength"]);
			Assert.AreEqual("Você deve digitar a senha atual.", result.ViewData.ModelState["currentPassword"].Errors[0].ErrorMessage);
        }
        ...
        public void ConstructorSetsProperties() {
			...
			IModuleRepository modRepo = new FakeModuleRepository();
        ...
        public void LoginPostReturnsViewIfPasswordNotSpecified() {
            ...
            // Assert
			Assert.AreEqual("Você deve preencher a senha.", result.ViewData.ModelState["password"].Errors[0].ErrorMessage);
        }
        ...
        public void LoginPostReturnsViewIfUsernameNotSpecified() {
            ...
            // Assert
            Assert.AreEqual("Você deve preencher o nome de usuário.", result.ViewData.ModelState["username"].Errors[0].ErrorMessage);
        }
        ...
        public void LoginPostReturnsViewIfUsernameOrPasswordIsIncorrect() {
            ...
            // Assert
            Assert.AreEqual("O nome de usuário ou senha digitada está incorreta.", result.ViewData.ModelState["_FORM"].Errors[0].ErrorMessage);
        }
        ...
        public void RegisterPostReturnsViewIfEmailNotSpecified() {
            ...
            // Assert
            Assert.AreEqual(6, result.ViewData["PasswordLength"]);
            Assert.AreEqual("Você deve fornecer um endereço de email.", result.ViewData.ModelState["email"].Errors[0].ErrorMessage);
        }
        ...
        public void RegisterPostReturnsViewIfNewPasswordDoesNotMatchConfirmPassword() {
            ...
            // Assert
            Assert.AreEqual(6, result.ViewData["PasswordLength"]);
			Assert.AreEqual("A senha e confirmação sevem ser iguais.", result.ViewData.ModelState["_FORM"].Errors[0].ErrorMessage);
        }
        ...
        public void RegisterPostReturnsViewIfPasswordIsNull() {
            ...
            // Assert
            Assert.AreEqual(6, result.ViewData["PasswordLength"]);
            Assert.AreEqual("Você deve digitar uma senha de 6 ou mais caracteres.", result.ViewData.ModelState["password"].Errors[0].ErrorMessage);
        }
        ...
        public void RegisterPostReturnsViewIfRegistrationFails() {
            ...
            // Assert
            Assert.AreEqual(6, result.ViewData["PasswordLength"]);
            Assert.AreEqual("O nome de usuário escolhido já existe. Por favor, escolha outro.", result.ViewData.ModelState["_FORM"].Errors[0].ErrorMessage);
        }
